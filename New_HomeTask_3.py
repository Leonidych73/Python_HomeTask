...
# 2 - somehow you need to get new list as old list without first two elements and last two elements.
# Print this new list
...
print('2-nd task ' + '_' * 50)  # _______________________________the_deviding_line
...
for x in new_people:
    if x[4] == 'male':
        ...
        count_female += 1
print("-" * SEP_NUM)
print(f"| {'sex':^{ALIGHT_NUM}} | {'count':^{ALIGHT_NUM}} |")
print("-" * SEP_NUM)
print(f"| {'female':^{ALIGHT_NUM}} | {count_female:^{ALIGHT_NUM}} |")
print(f"| {'male':^{ALIGHT_NUM}} | {count_male:^{ALIGHT_NUM}} |")
print("-" * SEP_NUM)
# ____________________________________________________
print('3-th task with flat list ' + '_' * 50)  # _______________

flat_list = list(itertools.chain.from_iterable(new_people))
print("-" * SEP_NUM)
print(f"| {'sex':^{ALIGHT_NUM}} | {'count':^{ALIGHT_NUM}} |")
print("-" * SEP_NUM)
...
print("-" * SEP_NUM)
# ____________end-line_2_______________________________
